...
set shortmess=aoO
badd +154 main.cpp
badd +242 ShapeFiles/MyShape.cpp
badd +23 ShapeFiles/MyShape.h
badd +403 Physics/Interactions.cpp
badd +69 Physics/WorldSettings.h
badd +507 Physics/Simulations.cpp
badd +123 Physics/WorldSettings.cpp
badd +76 Observation/Recording.cpp
badd +52 Observation/Recording.h
silent! argdel *
edit main.cpp
...
silent! normal! zE
let s:l = 333 - ((19 * winheight(0) + 13) / 26)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 433 - ((7 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
433
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 429 - ((19 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
429
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 421 - ((23 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
421
