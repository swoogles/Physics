...
set shortmess=aoO
badd +1 Windows/main_display.cpp
badd +239 main.cpp
badd +521 Physics/Simulations.cpp
badd +493 Physics/Interactions.cpp
badd +1 Physics/Interactions.h
badd +80 Physics/Simulations.h
silent! argdel *
edit main.cpp
...
silent! normal! zE
let s:l = 246 - ((19 * winheight(0) + 13) / 26)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 541 - ((26 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
541
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 28 - ((1 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
28
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 502 - ((17 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
502
