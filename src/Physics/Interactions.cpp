...
PhysicalVector Interactions::calcForceGravNew(Particle &object1, Moveable &object2, local_duration dt) const {
...
void Interactions::elasticCollision(Particle &object1, Particle &object2, local_duration dt) {
